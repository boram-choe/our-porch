      ...
      <div className="max-w-3xl mx-auto bg-slate-900 p-8 rounded-2xl border border-white/10 shadow-xl">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>원칙적으로, 개인정보 수집 및 이용 목적이 달성된 후(회원 탈퇴 시)에는 해당 정보를 지체 없이 파기합니다. 단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <section>
            ...
            <p>회사는 사용자의 현재 위치를 기반으로 '동네 인증'을 수행하기 위해 일회성으로 GPS 좌표를 수집합니다. 인증된 위치정보는 단순 주소(동 단위) 텍스트로만 변환되어 저장되며, 사용자의 실시간 이동 경로를 별도로 추적하거나 서버에 영구적으로 기록하지 않습니다.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">이용자는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 개인정보 보호책임자 혹은 담당부서로 신고하실 수 있습니다.</p>
          </section>
