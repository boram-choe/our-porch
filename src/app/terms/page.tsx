...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 p-6 md:p-12 font-sans overflow-y-auto">
      <div className="max-w-3xl mx-auto bg-slate-900 p-8 rounded-2xl border border-white/10 shadow-xl">
        <h1 className="text-2xl font-black text-amber-400 mb-8 pb-4 border-b border-white/10">여긴뭐가 서비스 이용약관</h1>
        
        <div className="space-y-6 text-sm leading-relaxed">
          <p>
            '여긴뭐가' (이하 '서비스')를 이용해 주셔서 감사합니다. 본 약관은 주식회사 채담(이하 '회사')이 제공하는 서비스의 이용 조건과 절차, 회사와 이용자 간의 권리·의무 및 책임사항을 규정합니다.
          </p>

          <section>
            <h2 className="text-lg font-bold text-white mb-2">제1조 (목적)</h2>
            <p>본 약관은 회사가 운영하는 '여긴뭐가' 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-white mb-2">제2조 (용어의 정의)</h2>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>'서비스'</strong>란 회사가 제공하는 동네 공실 정보 공유 및 커뮤니티 플랫폼 '여긴뭐가'를 의미합니다.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>서비스를 이용하여 얻은 정보를 회사의 사전 동의 없이 상업적 목적으로 활용할 수 없습니다.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-white mb-2">제5조 (회사의 면책)</h2>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>여긴뭐가는 주민들의 자발적 제보로 운영됩니다. 등록된 공실 정보는 참고용이며, 플랫폼은 실제 부동산 권리관계나 거래에 대해 법적 책임을 지지 않습니다.</li>
              <li>회사는 이용자 간 발생한 분쟁에 대해 개입할 의무가 없습니다.</li>
              <li>천재지변 또는 불가항력으로 인한 서비스 중단 시 회사는 책임을 지지 않습니다.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-white mb-2">제6조 (서비스 이용 제한)</h2>
            <p>회사는 다음 각 호의 경우 이용자의 서비스 이용을 제한하거나 계정을 삭제할 수 있습니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
