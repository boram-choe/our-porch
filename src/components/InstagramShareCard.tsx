        ...
        >
          ...
          <div className="relative z-10 w-full h-full bg-slate-900/70 backdrop-blur-xl border border-slate-700/60 rounded-[4rem] shadow-2xl flex flex-col p-14 justify-between items-center">
            ...
            <div className="w-full mt-6 mb-10">
              <div className="bg-purple-900/30 border-2 border-purple-500/40 rounded-[3.5rem] p-10 flex items-center gap-10">
                <div className="w-28 h-28 bg-purple-500/30 rounded-full flex items-center justify-center shrink-0 shadow-lg">
                  <Sparkles className="text-purple-300" size={50} />
                </div>
                <div className="flex-1">
                  <p className="text-[1.8rem] font-bold text-purple-300 mb-3">황금 개운 처방 ({getFortuneName(desiredFortune)})</p>
                  <p className="text-[3.2rem] font-black text-white break-keep leading-snug">{remedyTitle}</p>
                </div>
              </div>
            </div>
