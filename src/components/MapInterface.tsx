...
export default function MapInterface({ userProfile, onProfileUpdate }: { userProfile: UserProfile | null, onProfileUpdate: (updated: UserProfile | null) => void }) {
 ...
 className="w-11 h-11 md:w-14 md:h-14 bg-slate-950/95 rounded-xl md:rounded-2xl border border-white/10 flex items-center justify-center text-white shadow-[0_20px_40px_rgba(0,0,0,0.4)] pointer-events-auto hover:bg-slate-800 transition-all"
 >
 ...
 className="bg-white/95 px-3 md:px-4 py-2 md:py-2.5 rounded-xl md:rounded-2xl shadow-xl border border-white/20 flex items-center gap-2 md:gap-3 w-fit max-w-[95%] pointer-events-auto cursor-grab active:cursor-grabbing select-none"
 >
 ...
 <AnimatePresence>
 {showRegisterNudgePopup && !showFengShui && !showDashboard && (
