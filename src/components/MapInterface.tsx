    ...
    <div className="relative w-full h-screen bg-slate-950 font-sans overflow-hidden subpixel-antialiased text-slate-900">
      <div className="absolute top-6 left-0 right-0 px-4 z-[100] pointer-events-none">
        ...
        {userProfile && (
          <div className="flex justify-center mt-2 pointer-events-none">
            <div className="flex items-center gap-1.5 bg-slate-950/70 backdrop-blur-xl px-3 py-1 rounded-full border border-white/10">
      ...
      <AnimatePresence>
        ...
        {floorPickerGroup && (
          ...
          >
            <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={() => setFloorPickerGroup(null)} />
            <motion.div
      ...
      <AnimatePresence>
        ...
        {showMyPage && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 z-[170] shadow-2xl">
             <div className="absolute inset-0 bg-black/80 backdrop-blur-2xl" onClick={() => setShowMyPage(false)} />
