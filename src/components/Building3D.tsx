...
export default function Building3D({ vacancy, onClose, onVacancyUpdate, hasVoted, isEntrepreneurMode, onModeSwitch, userProfile, recommendedCategory }: { 
 ...
 <div className="relative w-48 h-full flex flex-col gap-2 p-1 bg-slate-900/20 rounded-b-xl border-x-4 border-b-4 border-slate-800 shadow-2xl">
 ...
 {/* 사진 장수 배지 표시 */}
 {allImages.length > 1 && (
 <div className="absolute top-6 right-6 bg-slate-950/95 text-amber-400 text-[10px] font-black px-3 py-1.5 rounded-full flex items-center gap-1 shadow-lg border border-white/10 select-none">
 <Maximize size={10} />
 ...
 <button onClick={onClose} className="pointer-events-auto w-12 h-12 bg-white/30 border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-white/30 active:scale-95 transition-all">
 <X size={24} />
 </button>
 ...
 {/* 2. 규모 태그 */}
 <div className="px-4 py-2 bg-white/30 text-white rounded-full text-xs font-bold border border-white/10 flex items-center gap-2">
 ...
 className="ml-auto bg-white/5 hover:bg-white/30 text-white px-3 py-1.5 rounded-lg text-[9px] font-black tracking-widest uppercase transition-all"
 >
 수정하기
 </button>
 )}
 ...
 */}
 ...
 className="flex-1 py-4.5 bg-white/5 border border-white/10 text-slate-300 font-black rounded-2xl text-sm hover:bg-white/30 transition-all"
 >
 돌아가기
 </button>
 <button 
 ...
 >
 <div className="absolute inset-0 bg-slate-950/95 " onClick={() => setShowComments(false)} />
 <motion.div 
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-[999] bg-slate-950/95 flex flex-col justify-between p-6 "
 >
 {/* 상단바: 닫기 버튼 및 타이틀 */}
 ...
 className="w-10 h-10 bg-white/30 hover:bg-white/30 active:scale-95 transition-all text-white rounded-full flex items-center justify-center border border-white/10"
 >
 <X size={20} />
 </button>
 </div>
 ...
 className="absolute left-2 md:left-4 z-20 w-12 h-12 bg-black/40 hover:bg-black/60 active:scale-90 transition-all text-white rounded-full flex items-center justify-center border border-white/5 "
 >
 ...
 className="absolute right-2 md:right-4 z-20 w-12 h-12 bg-black/40 hover:bg-black/60 active:scale-90 transition-all text-white rounded-full flex items-center justify-center border border-white/5 "
 >
 <ChevronDown className="w-6 h-6 -rotate-90" />
 </button>
 )}
